# Run this python file on raspberry pi using "sudo python ble_scan_connect.py"

from bluepy.btle import Peripheral, UUID
from bluepy.btle import Scanner, DefaultDelegate
import struct
import signal # ctrl + c handler  
import sys # ctrl + c handler  
